...
public:
    ...
    void queryRange(double x, double y, double width, double height) {
        vector<Point> result;
...
private:
    ...
    void queryRange(QuadtreeNode* node, double x, double y, double width, double height, vector<Point>& result) {
        if (node == nullptr) {
            return;
        }
...
int main() {
    ...
    quadtree.queryRange(20, 20, 50, 50);
