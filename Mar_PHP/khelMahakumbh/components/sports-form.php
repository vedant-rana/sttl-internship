...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $res = $player->insertIntoDatabase();

    if ($res == true) {
        echo "<script>showAlert('User Registered Successfully !!', 'alert-success');</script>";
    } else {
        echo "<script>showAlert('Error Occurred in user Creation!!', 'alert-danger');</script>";
    }
}
...
<body>
    ...
    <div class="container register-div">
        ...
        <form action="../admin/display_player.php" method="post">
            <h4 class="title"> Fetch Data From KMK ID</h4>
            <hr />
            <div class="row">
        ...
        <form action="../components/sports-form.php" method="post">
            <h4 class="title">Player Details</h4>
            <hr />
            <div class="row">
                <div class="form-group col-md-3">
            ...
            <h4 class="title">Guardians Details</h4>
            <hr />
            <div class="row">
                <div class="form-group col-md-3">
    ...
    <script src="../components/alertScript.js"></script>
